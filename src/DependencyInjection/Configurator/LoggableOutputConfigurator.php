...
final class LoggableOutputConfigurator
{
    ...
    public function __invoke(LoggableOutputInterface $loggableOutput): void
    {
        ...
        /*
         * We clone the logger to assure that each command gets it's unique stream handler,
         * eg when a command is called from another command, without cloning, both would get the same logger
